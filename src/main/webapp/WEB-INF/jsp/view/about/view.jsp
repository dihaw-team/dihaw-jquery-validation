...
<tiles:insertDefinition name="defaultTemplate">
    <tiles:putAttribute name="body">
		<div class="about">
			...
			<p>	
				This project developed By <a href="http://blog.dihaw.com" target="_blank">Wahid Gazzah</a> and <a href="http://team.dihaw.com/wael" target="_blank">Wael Boukadida</a>. 
				The source code is available in <a href="https://github.com/dihaw-team/dihaw-jquery-validation" target="_blank">Github</a>.
			</p>
			...
			<ul>
				...
				<li>Go to http://localhost:port/dihaw-jquery-validation/</li>
				<li>The <strong>log</strong> will be created on the <em>C:/dihaw/logs/dihaw-jquery-validation/SystemOut.log</em> file (see the <strong>logback.xml</strong> file)</li>
			</ul>
			</br></br>  
		</div>
    </tiles:putAttribute>
